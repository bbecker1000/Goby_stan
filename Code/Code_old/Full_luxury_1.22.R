...
#### 
## add Substrate RE  -----------------
## needs repair for the substrate RE - not working right.  2023-11-25
Goby.m2.year.DAG.SC.SB_counts.Breach.pois.Sub_RE <-  ulam(
  alist(
    #Goby model
    Goby ~ dgampois( mu, exp(phi)), 
    log(mu) <- 
...
precis(Goby.m2.year.DAG.SC.SB_counts.Breach.pois.Sub_RE, depth = 2)
plot(Goby.m2.year.DAG.SC.SB_counts.Breach.pois.Sub_RE, 
     pars = c("beta_Year", "beta_Substrate", "beta_Wind", "beta_Breach_count", "beta_Temp",
              "beta_DO", "beta_SB_count", "beta_SC_count", "beta_SAV", "beta_Rain"),
     xlab = "Beta Coefficient")

#plot(Goby.m1, depth = 2)
summary(Goby.m2.year.DAG.SC.SB_counts.Breach.pois.Sub_RE)
#traceplot(Goby.m2.no.year.DAG.SC.SB_counts.Breach.pois, ask = FALSE)
stancode(Goby.m2.year.DAG.SC.SB_counts.Breach.pois.Sub_RE)


save(Goby.m2.year.DAG.SC.SB_counts.Breach.pois.Sub_RE, file = "Output/Goby.m2.year.DAG.SC.SB_counts.Breach.pois.Sub_RE.RData")

## end add Substrate RE 
############-----------------
...
#### missing data full model
## drop some model terms
...
### add year for trend.
Goby.m2.NO.year.DAG.SC.SB_counts.Breach.pois.missing <-  ulam(
  alist(
    #Goby model
    Goby ~ dgampois( mu, exp(phi)), 
    log(mu) <- 
...
precis(Goby.m2.NO.year.DAG.SC.SB_counts.Breach.pois.missing, depth = 2)
plot(Goby.m2.NO.year.DAG.SC.SB_counts.Breach.pois.missing, 
     pars = c("beta_Year", "beta_Substrate", "beta_Wind", "beta_Breach_count", "beta_Temp",
              "beta_DO", "beta_SB_count", "beta_SC_count", "beta_SAV", "beta_Rain"),
     xlab = "Beta Coefficient",
     main = "No Year, Missing Data")

#plot(Goby.m1, depth = 2)
summary(Goby.m2.NO.year.DAG.SC.SB_counts.Breach.pois.missing)
#traceplot(Goby.m2.no.year.DAG.SC.SB_counts.Breach.pois, ask = FALSE)
stancode(Goby.m2.NO.year.DAG.SC.SB_counts.Breach.pois.missing)

save(Goby.m2.NO.year.DAG.SC.SB_counts.Breach.pois.missing, 
     file = "Output/Goby.m2.NO.year.DAG.SC.SB_counts.Breach.pois.missing.RData")
...
plot(Goby.m2.year.DAG.SC.SB_counts.Breach.pois.missing.drop.terms, 
     pars = c("beta_Year", "beta_Substrate", "beta_Wind", "beta_Breach_count", "beta_Temp",
              "beta_DO", "beta_SB_count", "beta_SC_count", "beta_SAV", "beta_Rain"),
     xlab = "Beta Coefficient",
     title = "Missing Data and drop terms Model")
